      ...
      <View style={{width: '100%', height: '100%', backgroundColor: 'rgba(217,217,217,0.7)'}}>
        ...
        <View style={styles.modalView} >
            <View style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end'}}>
                <Text style={{fontSize: 16, fontFamily: 'Cairo-Regular'}}>{item?.descripcion || "undefined"}</Text>
                <Text style={{fontSize: 12, fontFamily: 'Cairo-Bold'}}>{item?.peso?.cantidad || "undefined"} {item?.peso?.unidad  || "undefined"}</Text>
            </View>
            <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                <Text style={{fontSize: 12, fontFamily: 'Cairo-Regular'}}>#{item?._id || "undefined"}</Text>
            </View>
            <View style={{flexDirection: 'row', marginBottom: 5, justifyContent: 'space-between'}}>
                <Text style={{fontSize: 12, fontFamily: 'Cairo-Regular'}}><Text style={{fontFamily: 'Cairo-Bold'}}>{item?.stock || "undefined"}</Text> unidades</Text>
                <Text style={{fontSize: 12, fontFamily: 'Cairo-Bold'}}>${item?.precioUnitario || "undefined"} u.</Text>
            </View>
