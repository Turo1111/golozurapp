...
export default function ShippingSaleCard({length}) {
  ...
  return (
    <View>
        ...
        <View style={{borderWidth: 1, borderColor: '#d9d9d9', marginHorizontal: 15, marginVertical: 10, flexDirection: 'row', borderRadius: 15, padding: 5, justifyContent: 'space-around'}}>
