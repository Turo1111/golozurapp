...
return (
  <View style={styles.content}>
    ...
    <MyBottomSheet open={openBS} onClose={()=>setOpenBS(false)} height={95} >
      <SliderSale itemSlide={[<CartSale/>, <ClientSale data={clients} />, <ResumeSale/>]} />
    </MyBottomSheet>
    {/* <BottomSheet hasDraggableIcon ref={bottomSheet} height={560} sheetBackgroundColor={'#fff'} >
